...
* [metric naming policy](quality-metrics/naming-policy.md): current な metric、gate、review surface から Phase 名を外す命名方針と migration map。
...
* score-window musical acceptance: Phase 14 以降の top-level beauty evidence。譜面上の entry continuity、line agency、counter-subject survivability、phrase development を seed、tick、voice、role、音楽理論上の根拠へ戻して読めない metric は、採用判断ではなく調査 signal として扱う。
