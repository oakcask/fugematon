...
* [quality-metrics.md](quality-metrics.md): 音楽品質指標、diagnostics、reference profile、quality vector、採否 policy の入口。
...
* diagnostics、quality vector、reference profile、A/B adoption policy の意味を確認する場合は quality-metrics を読む。
