...
* Scope: Declarative and finite-domain constraint models for music theory, four-voice harmony, counterpoint, melodic/harmonic/rhythmic composition, and solver-backed composition diagnostics.
* Typical use: Calibrate Fugematon's local section constraint solver so hard constraints remain modular, soft costs stay review-visible, and external solver dependencies are deferred until a local bounded search fails measured targets.
* Reference ids: `anders-miranda-music-cp-2011`, `sprockeels-van-roy-diatony-2024`, `tanaka-first-species-ip-2022`, `boenn-anton-asp-2010`, `komosinski-szachewicz-counterpoint-2015`
* Verification level: page-checked
* Limits: These sources support constraint-model design and review framing. They do not require adopting Gecode, OR-Tools, ASP, integer programming, strict species counterpoint, or any new runtime dependency in Fugematon's browser-targeted v1 solver.

## species-dissonance-treatment

* Scope: Species-counterpoint and common-practice nonharmonic-tone evidence for treating dissonance as passing, neighboring, prepared suspension, or otherwise prepared/resolved context rather than as unexplained held vertical friction.
* Typical use: Calibrate diagnostics and soft scoring for weak passing dissonance, sustained semitone/tritone/fourth-above-bass windows, and suspension exceptions.
* Reference ids: `open-music-theory-second-species`, `open-music-theory-fourth-species`, `open-music-theory-species-counterpoint`, `fundamentals-function-form-nonharmonic-tones`
* Verification level: page-checked
* Limits: This family supports soft scoring, diagnostics, and review classification. It does not require strict species counterpoint for every Fugematon style profile and does not make all dissonance a hard failure.
...
## reference-corpus-and-generative-evaluation

* Scope: Reference-score ingestion, interpretable evaluation of generated four-part music, theory-guided statistical models, context-dependent fugal voice leading, and the separation of local voice-leading evidence from whole-form evidence.
* Typical use: Design a shared feature vocabulary for historical four-voice fugues and Fugematon output, then use blind pairwise preference only as an explainable ranking layer after hard constraints and score-window review.
* Reference ids: `music21-corpus-documentation`, `kernscores-corpus`, `humdrum-project-home`, `humdrum-bach-wtc-data`, `humdrum-mozart-quartets-data`, `fang-bach-or-mock-2020`, `zhu-bachmmmachine-2021`, `shapira-voice-leading-fugue-2023`, `marlowe-fugue-form-2020`
* Verification level: page-checked
* Limits: Chorale evaluation sources support local four-part harmony and voice-leading features, not fugal-form labels. Corpus availability does not establish redistribution rights for every score. These sources do not prove that one scalar learned score captures musical quality or that a shadow preference model should override hard constraints, localized score blockers, or style-specific review.
