...
* Phase 5 は音楽的品質ゲートとして扱う。
  ...
  * Phase 8 の操作パラメータは、Phase 7B の gate policy reset 後に hard constraint 上は増やせる状態になった。Phase 7B、Phase 10、Phase 11、Phase 12 は完了しており、Phase 6-7 の美しさ metric と manual listening は quality lane の evidence とする。現在は Phase 12 の phrase/repetition baseline を前提に、Phase 8 operational lane へ戻る。
