...
* Phase 5 は音楽的品質ゲートとして扱う。
  ...
  * Phase 8 の操作パラメータは、Phase 7B の gate policy reset 後に増やす。Phase 6-7 の美しさ metric と manual listening は quality lane の evidence とし、hard constraint と schema compatibility の通過を操作機能開始条件にする。
