...
* Harmonic stasis rearticulation repair: planned。Episode motivic development 後に、主題・応答・対主題由来の rhythm / derivation がある自由唱でも、first bass answer 後、all-free texture、functional-support 後処理で同音連打と和声停滞へ落ちる問題を Phase 8/9 前の品質 blocker として扱う。planned `harmonicStasisRearticulation` diagnostics は same-voice short rearticulation、role、metrical intent、harmonic function、first-bass-answer handoff、all-free texture、functional-support provenance、harmonic-sonority classification を同じ score-window へ戻す。採用は diagnostic、post-processing support guard、candidate scoring、必要時の generator alternatives の順に行い、単純な長音化で line agency を失う修理は採用しない。
* Phase 8: current implementation target after Harmonic stasis rearticulation repair and Stretto entry harmony repair。Metrical generation repair、Phase 14 14C4/14C5、Texture continuity repair、Historical reference calibration、Episode motivic development、Harmonic stasis rearticulation repair、Stretto entry harmony repair 後に、無限再生セッションの 3 再生モード semantics と segment snapshot contract を定義する operational lane。current scope は `continuous fugue`、`endless program`、`regenerative cycle` の違いを、曲間、segment 終止、主題記憶、調性/密度/疲労度の引き継ぎ、section bridge、snapshot からの生成再開の観点で説明することに限る。Phase 6-7 の美しさ metric と manual listening がすべて pass になることは開始条件にしないが、Phase 13X の first-bass repair evidence、Phase 13X2 の bass-answer-tail texture evidence and role visibility、Phase 13Y の generalized entry-continuity evidence、Phase 13Z の long-run phrase-development evidence、Phase 14 の score-led beauty、generalized harmonic-continuity、section-transition rhythm evidence、Metrical generation repair の time-signature / meter-context evidence、Texture continuity repair の exposed-solo evidence、Historical reference calibration の voice-pair / entry-support evidence、Episode motivic development の derivation evidence、Harmonic stasis rearticulation repair の first-bass-answer handoff and functional-support provenance evidence、Stretto entry harmony repair の first-stretto / important-entry sonority evidence は開始条件にする。3 モード定義と snapshot contract が音楽的な退屈さ、same-family phrase fatigue、line-coupling defects、entry boundary reset、bass-answer tail thinning、exposed free-counterpoint filler、generic subject-free spans、motivic labels without harmonic tension / release、metric false acceptance、unclear harmonic progression、unsettled transition rhythm、stretto entry harmony failure、拍子 metadata と聴感上の拍節感の不一致を隠す設計にならないよう、Phase 14、Metrical generation repair、Texture continuity repair、Historical reference calibration、Episode motivic development、Harmonic stasis rearticulation repair、Stretto entry harmony repair の review evidence baseline を前提にする。
