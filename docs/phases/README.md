...
* [Phase 7+ 再編計画](phase-7-plus-reorg.md): Phase 12 後に Phase 12P、Phase 13、Phase 13Q、Phase 13R、Phase 13S、Phase 13T、Phase 13U、Phase 13V、Phase 13W を挟み、音楽美を Phase 8/9 より優先した計画を確認する。
* [Phase 8](phase-8.md): 現在の次フェーズ。Phase 13W 後の operational lane。無限再生セッション、境界設計、内部状態 visualizer の MVP を扱う。
* [Phase 13W](phase-13w.md): 完了済み。Phase 13V 後に確認された bass entry 境界で外声 3 声が同時に再発音する問題を、Phase 8 前に generator と diagnostics で修正した。
