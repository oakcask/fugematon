...
* [Phase 9](phase-9.md): Phase 8 後の operational lane。Worker 化、生成期限、fallback、長時間再生 stability を扱う。fallback や UI presentation は Phase 8 で可視化した review signal を隠す代替にしない。
