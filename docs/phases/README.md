...
* [Phase 7+ 再編計画](phase-7-plus-reorg.md): Phase 11 完了後に Phase 8/9 の deferred operational lane へ戻る現在方針を確認する。
...
* 現在の実装対象を見る場合は [Phase 7+ 再編計画](phase-7-plus-reorg.md) の Phase 8/9 節を先に読む。
