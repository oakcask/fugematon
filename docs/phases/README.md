...
* [Phase 13W](phase-13w.md): 現在の次フェーズ。Phase 13V 後に確認された bass entry 境界で外声 3 声が同時に再発音する問題を、Phase 8 前に generator と diagnostics で修正する。
* [Phase 8](phase-8.md): Phase 13W 後の operational lane。無限再生セッション、境界設計、内部状態 visualizer の MVP を扱う。
