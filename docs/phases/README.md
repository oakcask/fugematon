...
* [Phase 7+ 再編計画](phase-7-plus-reorg.md): Phase 12 後に Phase 12P、Phase 13、Phase 13Q、Phase 13R、Phase 13S、Phase 13T を挟み、音楽美を Phase 8/9 より優先する現在計画を確認する。
* [Phase 13T](phase-13t.md): 現在の次フェーズ。Phase 13S 後の再レビューで見つかった entry sonority、voice lockstep、pitch-class unison、fragment function、modal counter-subject identity を Phase 8 前に修正する。
* [Phase 8](phase-8.md): Phase 13T 完了後の operational lane。無限再生セッション、境界設計、内部状態 visualizer の MVP を扱う。
...
* [Phase 9](phase-9.md): Phase 13T、Phase 8 後の Worker 化、生成期限、fallback、長時間 visualizer stability。
