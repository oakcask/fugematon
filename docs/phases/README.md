...
* [Phase 13X2](phase-13x2.md): 現在の実装対象。Phase 13X が直した entry 境界ではなく、ユーザー報告の本命と見られる first bass answer 後の free-counterpoint tail thinning と、piano-roll role visibility を扱う。
* [Phase 13Y](phase-13y.md): Phase 13X2 後の計画対象。entry-boundary continuity を bass 固有ではなく、entry voice、entry order、already-entered voices に基づく一般モデルへ広げる。
* [Phase 13X](phase-13x.md): 完了済み。Phase 13W が除外していた exposition の初回 bass answer で外声 3 声が同時に切れて再発音する問題を扱った。
* [Phase 13Z](phase-13z.md): Phase 13Y 後の計画対象。初期主題の多様性改善後も残る long-run phrase convergence を、subject-return / episode / stretto-like の発展不足として Phase 8 前に扱う。
* [Phase 14](phase-14.md): Phase 13Z 後の計画対象。指標が譜面上の美しさを証明していない問題を、score-window musical acceptance、entry continuity、line agency、counter-subject survivability、phrase development の統合再設計として扱う。
...
* 現在の実装対象を見る場合は [Phase 13X2](phase-13x2.md) と [../reviews/phase-13x2-bass-answer-texture-review.md](../reviews/phase-13x2-bass-answer-texture-review.md) を読む。Phase 13Y の generalized entry-continuity 計画を見る場合は [Phase 13Y](phase-13y.md) と [../reviews/phase-13y-entry-continuity-generalization.md](../reviews/phase-13y-entry-continuity-generalization.md) を読む。Phase 13X の完了 evidence は [Phase 13X](phase-13x.md)、[../reviews/phase-13x-completion-review.md](../reviews/phase-13x-completion-review.md)、計画根拠は [../reviews/phase-13x-first-bass-entry-review.md](../reviews/phase-13x-first-bass-entry-review.md) を読む。Phase 13Y 後の long-run phrase development 計画を見る場合は [Phase 13Z](phase-13z.md) と [../reviews/phase-13z-long-run-phrase-review.md](../reviews/phase-13z-long-run-phrase-review.md) を読む。Phase 13Z 後の score-led beauty rebuild は [Phase 14](phase-14.md) と [../reviews/phase-14-score-led-beauty-review.md](../reviews/phase-14-score-led-beauty-review.md) を読む。Phase 8 は Phase 14 後に読む。Phase 13W の post-exposition 完了 evidence は [Phase 13W](phase-13w.md)、[../reviews/phase-13w-completion-review.md](../reviews/phase-13w-completion-review.md)、計画根拠は [../reviews/phase-13w-entry-boundary-review.md](../reviews/phase-13w-entry-boundary-review.md) を読む。Phase 13V の完了 evidence は [Phase 13V](phase-13v.md)、[../reviews/phase-13v-completion-review.md](../reviews/phase-13v-completion-review.md)、計画根拠は [../reviews/phase-13v-score-beauty-audit.md](../reviews/phase-13v-score-beauty-audit.md) を読む。Phase 13U の完了 evidence と superseded handoff は [Phase 13U](phase-13u.md) と [../reviews/phase-13u-beauty-replan.md](../reviews/phase-13u-beauty-replan.md) を読む。Phase 13T の完了 evidence は [Phase 13T](phase-13t.md) と [../reviews/phase-13t-completion-review.md](../reviews/phase-13t-completion-review.md) を読む。Phase 13T の計画根拠は [../reviews/phase-13t-current-beauty-audit.md](../reviews/phase-13t-current-beauty-audit.md) を読む。直前の Phase 13S 完了 evidence は [Phase 13S](phase-13s.md) と [../reviews/phase-13s-music-beauty-review.md](../reviews/phase-13s-music-beauty-review.md) を読む。Phase 13R の完了 evidence、residual repair plan、post-listening blocker repair の根拠を見る場合は [Phase 13R](phase-13r.md)、[../reviews/phase-13r-convergence-review.md](../reviews/phase-13r-convergence-review.md)、[../reviews/phase-13r-subject-diversity-follow-up.md](../reviews/phase-13r-subject-diversity-follow-up.md) を読む。Phase 13Q の完了 evidence は [Phase 13Q](phase-13q.md) と [../reviews/phase-13q-voice-pair-support-review.md](../reviews/phase-13q-voice-pair-support-review.md)、quality vector の完了 evidence は [Phase 13](phase-13.md) と [../reviews/phase-13-quality-vector-review.md](../reviews/phase-13-quality-vector-review.md) を読む。
