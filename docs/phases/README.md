...
* [Phase 7+ 再編計画](phase-7-plus-reorg.md): Phase 12 後に Phase 12P、Phase 13、Phase 13Q、Phase 13R、Phase 13S、Phase 13T、Phase 13U、Phase 13V、Phase 13W、Phase 13X を挟み、音楽美を Phase 8/9 より優先した計画を確認する。
* [Phase 13X](phase-13x.md): 現在の実装対象。Phase 13W が除外していた exposition の初回 bass answer で外声 3 声が同時に切れて再発音する問題を Phase 8 前に扱う。
* [Phase 8](phase-8.md): Phase 13X 後の operational lane。無限再生セッション、境界設計、内部状態 visualizer の MVP を扱う。
