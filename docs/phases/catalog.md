...
* [Infinite playback MVP](phase-8.md): 現在の operational target。旧 Phase 8。Score-led beauty harmonic-continuity follow-up、Metrical generation repair、Texture continuity repair の review-required tradeoff を隠さない前提で、`continuous fugue`、`endless program`、`regenerative cycle` の 3 再生モード semantics と segment snapshot contract を扱う。
...
* operational target を見る場合は [Infinite playback MVP](phase-8.md) を読む。現在は 3 再生モード semantics と segment snapshot contract が scope。直前の品質 handoff baseline は [Score-led beauty handoff](phase-14.md)、[../reviews/phase-14-harmonic-continuity-generation.md](../reviews/phase-14-harmonic-continuity-generation.md)、[Metrical generation repair](metrical-generation-repair.md)、[../reviews/metrical-generation-repair-completion.md](../reviews/metrical-generation-repair-completion.md)、[Texture continuity repair](texture-continuity-repair.md) を読む。
