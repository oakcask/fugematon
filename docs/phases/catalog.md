...
* [Infinite playback MVP](phase-8.md): 現在の operational target。旧 Phase 8。Score-led beauty harmonic-continuity follow-up、Metrical generation repair、Texture continuity repair の review-required tradeoff を見える状態に保ちながら、無限再生セッション、境界設計、内部状態 visualizer の MVP を扱う。
