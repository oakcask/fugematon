...
* [Infinite playback MVP](phase-8.md): 現在の operational target。旧 Phase 8。Score-led beauty handoff、Metrical generation repair、Texture continuity repair、Historical reference calibration の review-required tradeoff を隠さない前提で、`continuous fugue`、`endless program`、`regenerative cycle` の 3 再生モード semantics と segment snapshot contract を扱う。
...
* operational target を見る場合は [Infinite playback MVP](phase-8.md) を読む。直前の品質 handoff baseline は [../reviews/phase-14-rhythm-harmony-handoff-completion.md](../reviews/phase-14-rhythm-harmony-handoff-completion.md)、[Metrical generation repair](metrical-generation-repair.md)、[../reviews/metrical-generation-repair-completion.md](../reviews/metrical-generation-repair-completion.md)、[Texture continuity repair](texture-continuity-repair.md)、[Historical reference calibration](historical-reference-calibration.md) を読む。
