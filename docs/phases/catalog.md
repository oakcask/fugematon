...
* [Score-led beauty handoff](phase-14.md): 現在の品質 blocker。`fugue-smoke` 第5小節の transition rhythm と第7小節の short-episode harmonic-continuity を、Infinite playback MVP の前に generalized score-window repair として扱う。
* [Historical reference calibration](historical-reference-calibration.md): 品質 blocker。探索的 Bach WTC diagnostics と現行生成 bundle の比較から、persistent voice-pair coupling、long pitch-class reinforcement、entry severe-interval pressure を Infinite playback MVP の前に扱う。
* [Infinite playback MVP](phase-8.md): 次の operational target。旧 Phase 8。Score-led beauty rhythm / harmonic-continuity follow-up、Metrical generation repair、Texture continuity repair、Historical reference calibration の review-required tradeoff を隠さない前提で、`continuous fugue`、`endless program`、`regenerative cycle` の 3 再生モード semantics と segment snapshot contract を扱う。
* [WebAudio synth interpretation follow-up](webaudio-synth-interpretation.md): Infinite playback MVP 後の rendering follow-up。WebAudio の envelope / velocity 解釈を `PerformanceProfile` 側で調整し、生成譜面や diagnostics を変えずに長時間再生の聴き取りやすさを扱う。
...
* 現在の品質 blocker を見る場合は [Historical reference calibration](historical-reference-calibration.md) と [../reviews/historical-reference-observation.md](../reviews/historical-reference-observation.md) を読む。
* operational target を見る場合は [Infinite playback MVP](phase-8.md) を読む。ただし現在は [Score-led beauty handoff](phase-14.md) が再オープンしているため、先に [../reviews/phase-14-fugue-smoke-rhythm-harmony-replan.md](../reviews/phase-14-fugue-smoke-rhythm-harmony-replan.md) を読む。直前の品質 handoff baseline は [../reviews/phase-14-harmonic-continuity-generation.md](../reviews/phase-14-harmonic-continuity-generation.md)、[Metrical generation repair](metrical-generation-repair.md)、[../reviews/metrical-generation-repair-completion.md](../reviews/metrical-generation-repair-completion.md)、[Texture continuity repair](texture-continuity-repair.md)、[Historical reference calibration](historical-reference-calibration.md) を読む。
