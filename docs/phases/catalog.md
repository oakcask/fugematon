...
* [Initial subject rhetoric diversity repair](initial-subject-rhetoric-diversity-repair.md): planned quality follow-up。主題が毎回似通って聞こえる問題を、固定 profile lookup ではなく opening gesture、climax、tail motion、rhythm、meter stress、modal color を持つ constrained subject-rhetoric generator と top-N diversity diagnostics で扱う。
