...
* [Episode motivic development](episode-motivic-development.md): 品質 blocker。Historical reference calibration 後に、自由唱と episode を主題・応答・対主題の断片、脚色、ゼクエンツ、転調準備として説明できるよう Infinite playback MVP の前に扱う。
...
* 現在の品質 blocker を見る場合は [Episode motivic development](episode-motivic-development.md) と [../reviews/episode-motivic-development-replan.md](../reviews/episode-motivic-development-replan.md) を読む。
* operational target を見る場合は [Infinite playback MVP](phase-8.md) を読む。直前の品質 handoff baseline は [../reviews/phase-14-rhythm-harmony-handoff-completion.md](../reviews/phase-14-rhythm-harmony-handoff-completion.md)、[Metrical generation repair](metrical-generation-repair.md)、[../reviews/metrical-generation-repair-completion.md](../reviews/metrical-generation-repair-completion.md)、[Texture continuity repair](texture-continuity-repair.md)、[Historical reference calibration](historical-reference-calibration.md)、[Episode motivic development](episode-motivic-development.md) を読む。
