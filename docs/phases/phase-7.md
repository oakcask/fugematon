...
その後、section-local planner 改善、reference corpus ingestion、percentile profile、manual pairwise preference は Phase 10 として先に進め、Phase 8/9 は deferred operational lane に送った。Phase 10、Phase 11、Phase 12、Phase 12P、Phase 13、Phase 13Q は完了し、Phase 13R では default baseline と phrase convergence の automatic adoption まで完了した。現在は Phase 13R follow-up repair として focused manual listening、seed 横断 subject-diversity repair、そこで見つかった音楽的問題の修正を Phase 8/9 前に行う。詳細は [Phase 7+ 再編計画](phase-7-plus-reorg.md)、[Phase 13Q](phase-13q.md)、[Phase 13R](phase-13r.md) を参照する。
