...
* [Generator constraint rebuild support cleanup trace review](generator-constraint-rebuild-support-cleanup-trace.md): current architecture evidence. Post-section support cleanup and focused texture voice-crossing surfaces now leave deterministic score-level before / after trace rows before adopted repairs.
