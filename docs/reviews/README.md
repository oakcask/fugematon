...
* [Phase 13X2](../phases/phase-13x2.md): 現在の実装対象。first bass answer 後の tail thinning と role-visible review output を扱う。
* [Phase 13Y](../phases/phase-13y.md): Phase 13X2 後の計画。entry-boundary continuity を bass-specific から entry-role / entry-order aware な診断と生成候補へ広げる。
...
* 最新の品質方針を見る場合は Phase 14 score-led beauty review、Phase 14、Phase 13Y entry-continuity generalization review、Phase 13Y、Phase 13X2 bass answer texture review、Phase 13X2、Phase 13X completion review、Phase 13X first bass entry review、Phase 13X、Phase 13Z long-run phrase review、Phase 13Z、Phase 13W completion review、Phase 13W entry-boundary review、Phase 13W、Phase 13V completion review、Phase 13V、Phase 13V score beauty audit、Phase 13U beauty replan review、Phase 13U、Phase 13T completion review、Phase 13T、Phase 13T current beauty audit、Phase 13S music beauty review、Phase 13S、Phase 13R の完了 evidence、Phase 13R convergence review、Phase 13R subject diversity follow-up、Phase 7+ 再編計画を先に読む。現在の実装対象は Phase 13X2、その後の計画対象は Phase 13Y、Phase 13Z、Phase 14。必要に応じて Phase 13Q planning review、Phase 13Q、Phase 13 quality vector review へ戻る。Phase 11 の実装済み観察軸を見る場合は Phase 11 review summary diagnostics を読む。Phase 7 以降の gate 再構成を見る場合は Phase 7 参照作品 diagnostics 計画を読む。Phase 12 挿入前の blocker evidence を見る場合は Phase 11 post-completion score review を読む。
