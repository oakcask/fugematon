...
* [Phase 14](../phases/phase-14.md): 現在の実装対象。score-window musical acceptance を metric acceptance より優先する生成モデル再設計。
