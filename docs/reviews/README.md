...
* [Generator constraint rebuild slice review](generator-constraint-rebuild-slice.md): current architecture-slice review. Adds diagnostics-only constraint evaluation and `generatorSearchTrace` without adopting new solver output; keeps hard failures contract-backed and leaves musical soft costs as review evidence.
