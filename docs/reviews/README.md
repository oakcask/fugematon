...
* 最新の品質方針や Phase 8/9 前の実装対象を見る場合は Phase 13R の required follow-up repair、Phase 13R convergence review、Phase 7+ 再編計画を先に読む。必要に応じて Phase 13Q planning review、Phase 13Q、Phase 13 quality vector review へ戻る。Phase 11 の実装済み観察軸を見る場合は Phase 11 review summary diagnostics を読む。Phase 7 以降の gate 再構成を見る場合は Phase 7 参照作品 diagnostics 計画を読む。Phase 12 挿入前の blocker evidence を見る場合は Phase 11 post-completion score review を読む。
