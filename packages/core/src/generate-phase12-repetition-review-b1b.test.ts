...
test("generateScore completes phase-12 repetition adoption across review seeds batch B1b", () => {
  const metrics = collectPhase12RepetitionMetrics(PHASE_12_REPETITION_REVIEW_BATCH_B.slice(3, 6));
