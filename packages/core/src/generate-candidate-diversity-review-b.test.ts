...
test("generateScore keeps candidate-diversity focused seed batch B ready for candidate-diversity review", () => {
  assertCandidateDiversityReviewSeedsReady(PHASE_13_FOCUSED_SEEDS.slice(4));
});
