...
test("generateScore completes phrase-repetition adoption across review seeds batch A2", () => {
  const metrics = collectPhraseRepetitionMetrics(PHRASE_REPETITION_REVIEW_BATCH_A.slice(6));
