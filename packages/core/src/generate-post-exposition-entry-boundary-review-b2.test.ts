...
test("post-exposition entry-boundary review bundle batch B2 exposes entry-boundary continuity diagnostics", () => {
  const seeds = POST_EXPOSITION_ENTRY_BOUNDARY_REVIEW_BATCH_B.slice(3);
