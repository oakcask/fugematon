...
test("generateScore completes phrase-repetition adoption across review seeds batch B2", () => {
  const metrics = collectPhraseRepetitionMetrics(PHRASE_REPETITION_REVIEW_BATCH_B.slice(6));
