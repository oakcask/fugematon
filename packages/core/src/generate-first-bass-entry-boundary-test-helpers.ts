...
export const FIRST_BASS_ENTRY_BOUNDARY_REVIEW_BATCH_D = FIRST_BASS_ENTRY_BOUNDARY_REVIEW_SEEDS.slice(17, 20);
export const FIRST_BASS_ENTRY_BOUNDARY_REVIEW_BATCH_D2 = FIRST_BASS_ENTRY_BOUNDARY_REVIEW_SEEDS.slice(20);
