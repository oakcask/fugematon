...
test("generateScore keeps candidate-diversity adoption seed batch B4 ready for generator-side quality work", () => {
  assertCandidateDiversityAdoptionSeedsReady(CANDIDATE_DIVERSITY_ADOPTION_SEEDS.slice(11));
});
