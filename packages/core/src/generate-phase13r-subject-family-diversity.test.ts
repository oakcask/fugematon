...
const PHASE_13R_REVIEW_SUBJECT_DIVERSITY_SEEDS = REPRESENTATIVE_REVIEW_SEEDS.slice(0, 4).map(({ seed }) => seed);

test("phase-13R default review subjects keep first-a family concentration below the repair ceiling", () => {
