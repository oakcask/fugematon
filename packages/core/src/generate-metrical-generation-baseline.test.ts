...
reviewTest("focused 3/4 metrical repair seeds establish triple-meter entry starts", () => {
...
reviewTest("focused 6/8 metrical repair seeds expose compound grouping", () => {
...
reviewTest("metrical repair controls include the reviewed common-time seed set", () => {
