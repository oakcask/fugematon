...
import { PHASE_5_11_ROTATION_SEEDS, PHASE_5_LENGTH_TICKS } from "./constants.js";
import { generateScore } from "./generate.js";

const PHASE_13R_ROTATION_SUBJECT_DIVERSITY_SEEDS = PHASE_5_11_ROTATION_SEEDS.slice(4).map(({ seed }) => seed);

test("phase-13R default rotation subjects keep second-batch family concentration below the repair ceiling", () => {
