...
const SUBJECT_FAMILY_DIVERSITY_REVIEW_SEEDS = REPRESENTATIVE_REVIEW_SEEDS.slice(0, 4).map(({ seed }) => seed);

reviewTest("phrase convergence review subjects keep first-a family concentration below the repair ceiling", () => {
