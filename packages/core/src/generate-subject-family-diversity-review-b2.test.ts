...
const SUBJECT_FAMILY_DIVERSITY_REVIEW_SEEDS = REPRESENTATIVE_REVIEW_SEEDS.slice(11).map(({ seed }) => seed);

test("phrase convergence review subjects keep second-b family concentration below the score-beauty ceiling", () => {
